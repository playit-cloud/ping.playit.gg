...
export default function TestResultsModal({
  ...
  const successfulValues = values.filter((value) => !value.error);
  const bestLatency =
    successfulValues.length > 0
      ? Math.min(...successfulValues.map((value) => value.latencyAvg))
      : 0;

  const gl = pingResults["GlobalAnycast"];
  const glFailed = !gl || !!gl.error;
  const best = successfulValues.find((value) => value.latencyAvg === bestLatency);
      ...
      >
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {glFailed ? (
              <div
                className="border-l-4 border-l-red-500 border-t border-r border-b border-red-900 p-4"
              ...
              >
                ...
                <div
                  className="text-sm font-sans border-t pt-3 text-zinc-400"
              ...
              <div
                className="border-l-4 border-l-sky-500 border-t border-r border-b p-4"
                style={{
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    className="font-pixel text-[8px] px-2.5 py-1 uppercase text-zinc-400"
                ...
                <div
                  className="text-sm font-sans space-y-1.5 border-t pt-3"
                  style={{ borderColor: "var(--border-primary)" }}
                >
          ...
          {glFailed || bestFailed ? (
            <div className="bg-red-950/50 border-2 border-red-600 p-5">
              ...
              <p className="text-zinc-300 font-sans text-sm m-0 leading-relaxed">
                Some servers could not be reached during testing. This may be due
                to network issues or temporary server unavailability. Please try
            ...
            <div className="bg-emerald-950/50 border-2 border-emerald-600 p-5">
              ...
              <p className="text-zinc-300 font-sans text-sm m-0 leading-relaxed">
                Your ISP is already routing you to the best available datacenter.
                A regional tunnel would not improve your connection speed.
              </p>
            </div>
          ) : (
            <>
              ...
              >
                  ...
                  <div>
                    <div className="flex justify-between text-sm font-sans mb-2">
                      <span className="text-zinc-300">
                        Global Anycast <span className="text-zinc-500">[FREE]</span>
                      </span>
                    ...
                    <div
                      className="h-5 border overflow-hidden"
                      style={{
                        backgroundColor: "var(--bg-card)",
                        borderColor: "var(--border-primary)",
                      }}
                ...
                <div
                  className="mt-5 pt-4 border-t-2 flex items-center justify-center gap-4"
                  style={{ borderColor: "var(--border-primary)" }}
                >
